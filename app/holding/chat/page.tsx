...
// IMPORTANT:
// This is now the holding-wide message stream.
// Messages are NOT restricted to one session when displayed.
...
```
  ...
  // CRITICAL:
  // Load ALL messages belonging to this holding.
  // Do NOT filter by session_id.
...
* HOLDING-WIDE REALTIME
*
* Every authorized account connected to this holding
...
if (loading) {
return ( <div className="min-h-screen flex items-center justify-center muted">
Opening NEVU Chat… </div>
);
}
...
if (error) {
return ( <div className="text-xs text-red-300">
Attachment unavailable: {error} </div>
);
}

if (!url) {
return ( <div className="text-xs opacity-60">
